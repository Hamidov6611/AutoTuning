      ...
      <div className="w-[98%] mb-20 st:max-w-[1280px] mx-auto flex flex-col gap-y-6 tl:gap-y-16 px-[3%] sl:px-0 sm:py-[30px] ol:gap-y-[60px]">
        ...
        <div className="flex lg:flex-row flex-col gap-x-8 gap-y-4 lg:items-center">
          ...
          <div className="lg:w-1/2 w-full flex flex-col gap-y-4">
            <Paragraph>
              ...
              соответствует европейским стандартам чистоты воздуха. Хотя,
              будучи, гражданином Украины вы можете без проблем ездить за
              границей на своем авто без катализатора. Ведь вам не приходится
              проходить их  техосмотр, который для них является регулярно
              обязательным.
            </Paragraph>
            <Paragraph>
        ...
        <div className="flex flex-col gap-y-4">
          <Paragraph>
            ...
            Предназначен для контроля выхлопных газов. Обеспечивает нормы
            Евро-2.
          </Paragraph>
          <Paragraph>
            2. Лябда-зонд 2 или ДК2 после катализатора. Предназначен для
            контроля состояния катализатора. Обеспечивает нормы выхлопа Евро-3,
          ...
          <Paragraph>
            3. Катализатор. Если он забит или выскакивает ошибка по катализатору
            или второму лямбда-зонду (дк2), мы его отключим. Дальше катализатор
            можно вырезать, приварив на его место прямую трубу или стронгер
