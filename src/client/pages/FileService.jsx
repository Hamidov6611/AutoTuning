      ...
      <div className="w-[98%] mb-20 st:max-w-[1280px] mx-auto flex flex-col gap-y-6 tl:gap-y-16 px-[3%] sl:px-0 sm:py-[30px] ol:gap-y-[60px]">
        ...
        <div className="flex flex-col gap-y-3 w-full text-base text-mainBlack font-montserrat font-normal">
          ...
          <ul className="space-y-3">
            ...
            <li>Время подготовки стандартного файла составляет от 1 до 3 часов, при добавлении определенного количества опцией, <br className="lg:flex hidden"/> или выполнение индивидуального заказа, срок может увеличится до 5 часов.</li>
            <li>Так же мы проводим обучение в подборе оборудования нужного именно вам, и работе на нем. Для дилеров нашей <br className="lg:flex hidden"/> компании обучение бесплатное.</li>
