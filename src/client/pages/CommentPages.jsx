    ...
    >
      <div className="w-[98%] mb-20 st:max-w-[1280px] mx-auto flex flex-col gap-y-6 tl:gap-y-16 px-[3%] sl:px-0 sm:py-[30px] ol:gap-y-[60px]">
        ...
        <Paragraph>
          ...
          двигателем. Установка аэродинамических элементов внешнего
          <br className="lg:flex hidden" /> стайлинга от ведущих мировых
          производителей – мы имеем собственный малярный цех и современное
          оборудование. Мультимедиа и дизайн салона
          <br className="lg:flex hidden" /> – как неотъемлемая часть
          комплексного тюнинга. Техническое обслуживание, расширенная
          диагностика и весь спектр услуг по ремонту автомобилей.
        </Paragraph>
        ...
        <div className="flex gap-x-[55px] lg:flex-row flex-col gap-y-4 items-center">
          ...
          <div className="flex flex-col gap-y-3">
            <Paragraph>
              Настройка блока управления двигателем доработанного
              <br className="lg:flex hidden" /> автомобиля проводится на
              мощностном стенде. Мы
              <br className="lg:flex hidden" /> разрабатываем уникальную
              прошивку, адаптированную под
              <br className="lg:flex hidden" /> специфику конфигурации силового
              агрегата. Даже чип-
              <br className="lg:flex hidden" />
              тюнинг серийного автомобиля в нашем исполнении не
              <br className="lg:flex hidden" /> сводится просто к записи
              измененного файла. Мы проводим
              <br className="lg:flex hidden" />
              комплексную диагностику всех параметров работы
              <br className="lg:flex hidden" /> двигателя на новой прошивке и
              корректируем её под
              <br className="lg:flex hidden" /> используемое топливо, измененные
              системы впуска-
              <br className="lg:flex hidden" />
              выпуска, климатические условия и особенности стиля
              <br className="lg:flex hidden" />
        ...
        <div className="flex lg:flex-row flex-col gap-y-8">
          <div className="w-full lg:w-2/3 flex flex-col gap-y-8">
            <p className="text-base sm:text-[18px] lg:text-[20px] font-montserrat font-normal">
              ...
              подобные
              <br className="lg:flex hidden" /> услуги?
            </p>
