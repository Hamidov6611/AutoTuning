...
import AddBrand from "../components/brand/addService";
import EditBrand from "../components/brand/editService";
import RemoveBrand from "../components/brand/removeService";
...
const AdminBrand = () => {
  ...
  const getData = async () => {
    try {
      const { data } = await instance(`/brand?page=${pageId}&limit=10`);
        ...
        <div class="rounded-sm  border-stroke bg-[#24303f] w-[98%] mx-auto px-5 pt-6 pb-2.5 shadow-default sm:px-7.5 xl:pb-1">
          <div class="max-w-full overflow-x-auto">
            <table class="w-full table-auto">
              ...
              {isOpen && <AddBrand setIsOpen={setIsOpen} getData={getData} />}
              {isRemove && (
                <RemoveBrand
