...
import AddModal from "../components/stage2/addModal";
import EditBrand from "../components/stage2/editModal";
import RemoveBrand from "../components/stage2/removeModal";
  ...
  const getData = async () => {
    try {
      const { data } = await instance(
        `/stage2/pagination?page=${pageId}&limit=10`
      );
