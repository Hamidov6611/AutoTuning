...
import AddModal from "../components/stage/addModal";
import EditBrand from "../components/stage/editModal";
import RemoveBrand from "../components/stage/removeModal";
  ...
  const getData = async () => {
    try {
      const { data } = await instance(
        `/stage1/pagination?page=${pageId}&limit=10`
      );
